...
urlpatterns = [
    ...
    # fixed the ckeditor issue of requiring admin login
    #https://stackoverflow.com/questions/58904408/django-ckeditor-upload-permission-for-all-users-add-scroll-bar-automatically
